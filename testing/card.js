...
class Card {
    ...
    Requires:
        ...
        in ['red', 'purple', 'green'], number in [1,2,3].
    */
...
*/
function generateDeck(cardDeck) {
...
*/
function generateCardLookup(cardLookupTable) {
    card_id = 1;
...
module.exports.generateCardLookup = generateCardLookup;
